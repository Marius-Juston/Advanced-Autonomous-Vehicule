...
vector<float> initialize_priors(int map_size, const vector<float> &landmark_positions,
...
vector<float> pseudo_range_estimator(const vector<float> &landmark_positions,
